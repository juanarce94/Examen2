...
public class NavigationDrawer extends AppCompatActivity
        ...
        DisableFragment.OnFragmentInteractionListener{
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        }else if (id == R.id.Edit_transaction) {
            Fragment fragment = new EditFragment();
            getSupportFragmentManager().beginTransaction().replace(R.id.content_dashboard, fragment).commit();
        } else if (id == R.id.Disable_transaction) {
            Fragment fragment = new DisableFragment();
            getSupportFragmentManager().beginTransaction().replace(R.id.content_dashboard, fragment).commit();
        } else if (id == R.id.Transaction_list) {
